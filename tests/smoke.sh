...
echo ""
echo "=== source=gal ==="
check "gal 1h"                    "/api/articles?source=gal&hours=1"                                       "d['total'] > 0 and d.get('source') == 'gal'"
...
check "gal fda view 3d"           "/api/articles?source=gal&view=fda-medical-devices&hours=72"             "d.get('source') == 'gal'"

echo ""
echo "=== source=gkg ==="
check "gkg 1h"                    "/api/articles?source=gkg&hours=1"                                       "d['total'] > 0 and d.get('source') == 'gkg'"
...
check "gkg fda view 3d"           "/api/articles?source=gkg&view=fda-medical-devices&hours=72"             "d.get('source') == 'gkg'"

echo ""
echo "=== source=all ==="
check "all 1h"                    "/api/articles?source=all&hours=1"                                       "d['total'] > 0 and d.get('source') == 'all'"
...
check "unknown source falls back" "/api/articles?source=bogus&hours=1"                                     "d.get('source') == 'gal'"
